...
public class l3exercise {
	...
	public static void main(String[] args) {
		...
		System.out.println(word2.substring(0,5).toUpperCase()+"\n"+word5.substring(12,15) +word2.substring(8,12).toUpperCase());
		...
		System.out.println();
		String word7 = "Peter Piper Pickled A Peck Of Picked Peppers";
		System.out.println(word7.substring(19, 36)+"          "+word7.substring(36,44)+" "+word7.substring(0,11)+"    "+word7.substring(28,36));
